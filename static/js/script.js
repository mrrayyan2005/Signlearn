...
//   document.getElementById('Demo-link').textContent = translation.DemoLink;
...
document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('alphabet-btn1').addEventListener('click', function() {
        fetch('/learn-alphabets1', {
            method: 'POST'
        })
        .then(response => {
            if (response.redirected) {
